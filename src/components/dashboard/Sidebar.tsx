// /src/components/os/Sidebar.tsx (Fixed - remove scroll)
"use client"
...
const navItems = [
  ...
  { id: "posts", label: "Posts", icon: PenSquare, path: "/posts" },
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-[rgb(var(--border)/0.4)]">
          ...
          >
            ...
            <div>
              <h1 className="font-semibold text-[rgb(var(--foreground))] text-sm">Brainiark</h1>
              <p className="text-xs text-[rgb(var(--muted-foreground))]">OS</p>
            </div>
          </motion.div>
        ...
        <div className="p-4 border-t border-[rgb(var(--border)/0.4)] space-y-4">
          <div className="flex items-center justify-between">
            ...
            <motion.div
              animate={{ opacity: isExpanded ? 1 : 0 }}
              className={`flex items-center gap-2 ${!isExpanded && "w-0 overflow-hidden"}`}
            >
              ...
              <div>
                <p className="text-xs font-medium text-[rgb(var(--foreground))]">Alex</p>
                <p className="text-xs text-[rgb(var(--muted-foreground))]">Admin</p>
              </div>
            </motion.div>
          </div>
        </div>
